...
public class KafkaProducer {
	...
	/*
	 * @Test public void sendMsg() throws Exception { //从redis获取数据
	 * ListOperations<String, Article> opsForList = redisTemplate.opsForList();
	 * 
	 * List<Article> list = opsForList.range("articles", 0, -1); //发送到kafka for
	 * (Article article : list) { //转成json Gson gson = new Gson();
	 * 
	 * String json = gson.toJson(article); //发送 kafkaTemplate.sendDefault(json); } }
	 */
	@Test
	public void addMsg() {
//		获取redis的数据
